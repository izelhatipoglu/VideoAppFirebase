...
class ViewModelFactory() : ViewModelProvider.NewInstanceFactory() {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when{
            modelClass.isAssignableFrom(InfoHomeViewModel::class.java)-> InfoHomeViewModel(application = Application()) as T
            modelClass.isAssignableFrom(SettingViewModel::class.java)-> SettingViewModel(application = Application()) as T
            modelClass.isAssignableFrom(SecondHomeViewModel::class.java)-> SecondIntroViewModel(application = Application()) as T
